...
public class Shipment {
  ...
  private List<String> shipmentItems;
  ...
  public Shipment(int shipmentNumber, LocalDate shipmentDate, List<String> shipmenItems, Store shipmentStore, String shipmentHandler) {
